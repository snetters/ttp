...
class CreateAccountForm extends React.Component {
    ...
    axios.get('http://localhost:3000/backend/createAccount', {
        params: {
            email: cS.email,
    ...
    axios.post('http://localhost:3000/backend/createAccount', {
        params: {
            email: cS.email,
            username: cS.username,
            pass: cS.pass,
    ...
    .then((response) => {
        ...
        const apiResponse = { email: e, username: u, pass: p, verified: v }
    ...
    componentDidMount() {
        this.setState({ email: 'initEmail', username: 'initUsername', pass: 'initPass', passConf: 'initPassConf' })
    }
        ...
        return (
            <div className="CreateAccountForm">
                <form onSubmit={this.handleSubmit}>
                    ...
                    <input type="password" placeholder='confirm pass' name="passConf" onChange={this.handleInputChange}/>
                    <br />
