...
class Profile extends React.Component {
    ...
    saveUp(state) {
        this.setState({ username: state.username, pass: state.pass, loggedIn: state.verified })
    ...
    unloggedMode() {
        return (
            <div className="Unlogged">
                ...
                <Switch>
                    <Route exact path='/profile/createAccount'
            ...
            <div className="Logged">
                ...
                <Switch>
                    ...
                    <Route exact path='/profile/myProfile'
                        render={() => <MyProfile
                            saveUp={ this.saveUp } profState={ this.state }  />}
                     />
